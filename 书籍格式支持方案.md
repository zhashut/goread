...
#### Phase 2: Markdown 支持 (3h)

- [ ] 安装 `md-editor-rt` npm 包
- [ ] 实现 `src-tauri/src/formats/markdown/mod.rs`（文件读取 + 编码检测）
- [ ] 添加 `markdown_load_document` 命令
- [ ] 实现 `src/services/formats/markdown/MarkdownRenderer.ts`
- [ ] 配置主题支持（light/dark/sepia）
- [ ] 测试 Markdown 阅读（包含代码高亮、表格、图表等）
