...
export const READER_FLOAT_BUTTON_EDGE_OFFSET = 25;
export const READER_FONT_CONTROL_EDGE_OFFSET = READER_FLOAT_BUTTON_EDGE_OFFSET;
export const READER_FONT_CONTROL_TOP = -68;
export const READER_FONT_CONTROL_WIDTH = 44;
export const READER_FONT_CONTROL_BUTTON_SIZE = 44;
export const READER_FONT_CONTROL_TRACK_HEIGHT = 156;
export const READER_FONT_CONTROL_TRACK_WIDTH = 14;
export const READER_FONT_CONTROL_THUMB_SIZE = 20;
export const READER_FONT_SLIDER_WIDTH = 44;
export const READER_FONT_SLIDER_HEIGHT = 160;
export const READER_FONT_SLIDER_TOP =
  READER_FONT_CONTROL_TOP + READER_THEME_BUTTON_SIZE - READER_FONT_SLIDER_HEIGHT;
export const READER_FONT_SLIDER_RADIUS = 22;
export const READER_FONT_SLIDER_PADDING_Y = 12;
export const READER_FONT_SLIDER_ICON_PADDING = 5;
export const READER_FONT_SLIDER_TRACK_WIDTH = 4;
export const READER_FONT_SLIDER_THUMB_SIZE = 16;
